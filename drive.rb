...
run_test("\"#{$OS_EXE}\" --verbose test2.rb", 'out1.json')
#run_test("bundle exec \"#{$OS_EXE}\" --verbose test2.rb", 'out2.json')
...
run_test("\"#{$OS_EXE}\" --verbose test2.rb", 'out7.json')
run_test("ruby -I '#{$OS_RB}' test2.rb", 'out8.json')